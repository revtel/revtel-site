module.exports = {
  ...
  siteTitle: "技術 + 專業 + 熱情", // Site title.
  siteTitleAlt: "Revtel's Blog", // Alternative site title for SEO.
  siteLogo: "/logos/logo-revtel.png", // Logo used for SEO and manifest.
  siteUrl: "https://revtel.github.io", // Domain of your website without pathPrefix.
  pathPrefix: "/", // Prefixes all links. For cases when deployed to example.github.io/gatsby-advanced-starter/.
  siteDescription: "技術 x 專業 x 熱情", // Website description used for RSS feeds/meta description tag.
  ...
  copyright: "Copyright © 2018. Revteltech", // Copyright string for the footer of the website and RSS feed.
  themeColor: "#80DEEA", // Used for setting manifest and progress theme colors.
